...
pi_usage = "Rebalance/4/logs_edge/cpu_mem_monitor_pi.txt"
fog_usage = "Rebalance/4/logs_fog/cpu_mem_monitor_fog.txt"
cloud_usage = "Rebalance/4/logs_cloud/cpu_mem_monitor_cloud.txt"
...
###################################
fig,ax = plt.subplots()
#plt.title('CPU Consumption for ALPR Rebalance')
...
ax.set_ylim(ymin=0)
ax.yaxis.set_ticks(np.arange(0, 70, 10))
...
###################################
fig,ax = plt.subplots()
plt.title('Memory Consumption for ALPR Rebalance')
